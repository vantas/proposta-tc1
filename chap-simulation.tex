...
TO-DO: Onde observaremos? % TO-DO

\item \textit{Quando não há possibilidade de verificar a validade do modelo}

TO-DO: Como verificaremos a validade do modelo? % TO-DO
...
Em função destas reflexões acredita-se que a simulação como uma forma apropriada
...
um evento, os períodos de espera - ou seja, o tempo entre a ocorrência de um
...
da simulação} é alterado sempre no mesmo incremento, independente de ocorrência
