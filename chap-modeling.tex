...
ocorrer, confirme ilustrado pela figura \textbf{XXXXX (TO-DO: fazer uma figura
bonitinha para ilustrar a priority queue)}.

A classe \textit{EventQueue} encapsula uma fila prioritária de eventos,
...
\textit{Sistema de Gerência de Eventos}, ou \textit{SGE}.
