...
para vários passos no futuro~-~como em um jogo de xadrez. Busca-se o
...
A literatura neste tópico é bastante escassa ainda. No entanto, uma possível
implementação desta solução seria algo como:
