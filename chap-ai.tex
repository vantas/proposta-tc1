...
Seu funcionamento é muito trivial: o elevador mais próximo do chamado sempre
atenderá este.

\section{\label{sec:ai:nnm}Nearest Neighbour Melhorado}

Uma melhoria óbvia que pode ser feita ao algoritmo de \textit{Nearest Neighbour}
...
O primeiro algoritmo de IA a ser testado é bastante simples: definimos uma
...
mais próximos um dos outro.\footnote{Podemos elevar cada termo do somatório ao
...
A idéia do algoritmo de planning é extender o de função de custo, calculando a
